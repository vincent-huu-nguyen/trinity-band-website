    ...
    <div className="min-h-screen py-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-trinity-text-light mb-6">
              ...
              <p className="text-lg text-trinity-text-light">
      ...
      <section className="py-16 bg-trinity-primary-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-trinity-primary rounded-lg p-8 max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              <div className="text-center md:text-left">
                <div className="w-32 h-32 bg-trinity-primary-lighter rounded-full mx-auto md:mx-0 mb-4 flex items-center justify-center">
              ...
              <div className="md:col-span-2">
                <h3 className="text-2xl font-bold text-white mb-3">Mr. John Smith</h3>
