    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-trinity-primary via-trinity-primary-dark to-trinity-primary-darker text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Welcome to <span className="text-trinity-secondary">Trinity Band</span>
          </h1>
          <p className="text-xl md:text-2xl text-trinity-primary-lighter mb-8 max-w-3xl mx-auto">
      ...
      <section className="py-16 bg-trinity-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-title">Why Choose Trinity Band?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card-hover text-center">
              ...
              <h3 className="text-xl font-semibold text-trinity-primary mb-3">Musical Excellence</h3>
            ...
            <div className="card-hover text-center">
              ...
              <h3 className="text-xl font-semibold text-trinity-primary mb-3">Community Building</h3>
              <p className="text-trinity-primary-light">
            ...
            <div className="card-hover text-center">
              ...
              <h3 className="text-xl font-semibold text-trinity-primary mb-3">Performance Opportunities</h3>
              <p className="text-trinity-primary-light">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <Link to="/events" className="group">
              <div className="card-hover text-center group-hover:border-trinity-secondary transition-all duration-200">
                ...
                <h3 className="font-semibold text-trinity-primary group-hover:text-trinity-secondary transition-colors duration-200">Events</h3>
              </div>
            </Link>
            <Link to="/store" className="group">
              <div className="card-hover text-center group-hover:border-trinity-secondary transition-all duration-200">
                ...
                <h3 className="font-semibold text-trinity-primary group-hover:text-trinity-secondary transition-colors duration-200">Store</h3>
              </div>
            </Link>
            <Link to="/newsletter" className="group">
              <div className="card-hover text-center group-hover:border-trinity-secondary transition-all duration-200">
                ...
                <h3 className="font-semibold text-trinity-primary group-hover:text-trinity-secondary transition-colors duration-200">Newsletter</h3>
              </div>
            </Link>
            <Link to="/sponsors" className="group">
              <div className="card-hover text-center group-hover:border-trinity-secondary transition-all duration-200">
                ...
                <h3 className="font-semibold text-trinity-primary group-hover:text-trinity-secondary transition-colors duration-200">Sponsors</h3>
              </div>
            </Link>
          </div>
        </div>
