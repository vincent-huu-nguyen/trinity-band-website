          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="rounded-lg shadow-lg bg-white text-black overflow-hidden hover:shadow-xl transition-all duration-200">
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-black mb-2">Spring Concert</h3>
                    <p className="text-black">Annual spring performance featuring all ensembles</p>
                  </div>
            ...
            <div className="rounded-lg shadow-lg bg-white text-black overflow-hidden hover:shadow-xl transition-all duration-200">
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-black mb-2">Band Camp</h3>
                    <p className="text-black">Intensive summer training for marching band</p>
                  </div>
                  <div className="text-right">
            ...
            <div className="rounded-lg shadow-lg bg-white text-black overflow-hidden hover:shadow-xl transition-all duration-200">
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-black mb-2">Football Game</h3>
                    <p className="text-black">Marching band performance at the home game</p>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-black">28</div>
                    <div className="text-sm text-black">SEP</div>
                  </div>
                </div>
                <div className="space-y-2 text-sm text-black">
                  <div className="flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-black">May 2024</h3>
            </div>
                ...
                return (
                  <div
                    ...
                    className={`text-center py-2 text-sm border border-trinity-gray-dark ${
                      hasEvent ? 'bg-trinity-secondary text-white font-semibold' : 'text-black'
                    }`}
                  >
                    {day}
                  </div>
            ...
            <div className="rounded-lg shadow-lg bg-white text-black overflow-hidden hover:shadow-xl transition-all duration-200">
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-trinity-secondary rounded-full flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-black">Winter Concert</h3>
                    <p className="text-black text-sm">December 15, 2023</p>
                  </div>
                </div>
            ...
            <div className="rounded-lg shadow-lg bg-white text-black overflow-hidden hover:shadow-xl transition-all duration-200">
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-black">State Competition</h3>
                    <p className="text-black text-sm">November 8, 2023</p>
                  </div>
                </div>
                <p className="text-black mb-4">
